      ...
      <AdminPageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/admin/media/calendar" className="rounded-xl border border-white/10 px-4 py-2 text-sm font-bold text-white/65">Publishing queue</Link>
            <Link href="/admin/media/learning" className="rounded-xl border border-white/10 px-4 py-2 text-sm font-bold text-white/65">Learning</Link>
          </div>
        }
      />
