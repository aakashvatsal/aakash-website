  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5">
        ...
        <AdminStatCard
          label="Open tasks"
          value={stats.tasks.totalOpen}
          description={`${stats.tasks.dueToday} due today · ${stats.tasks.overdue} overdue`}
          icon={CheckSquare2}
        />

        <AdminStatCard
          label="Reminders"
          value={stats.reminders.dueNow}
          description={`${stats.reminders.upcomingToday} upcoming · ${stats.reminders.snoozed} snoozed`}
          icon={BellRing}
        />

        <AdminStatCard
          label="Brain dump"
          value={stats.brainDump.inbox}
          description={`${stats.brainDump.capturedToday} captured today`}
          icon={Brain}
        />

        <AdminStatCard
          label="Meditation"
          value={stats.meditation.minutesThisWeek}
          description={`${stats.meditation.completedThisWeek} completed sessions this week`}
          icon={Sparkles}
        />
      </section>
